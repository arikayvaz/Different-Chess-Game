namespace DCG.Gameplay
{
    ...
    [CreateAssetMenu(fileName = "RookMovementCalculator", menuName = "DCG/Chess Unit/Movement/Rook Movement Calculator")]
    public class RookMovementCalculatorSO : ChessUnitMovementCalculatorSO
    {
